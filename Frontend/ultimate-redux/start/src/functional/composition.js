...
// const wrapUndefined = (type, str) => `<${type}>${str}</${type}>`
...
// const transformCorrectly = pipe(trim, toLowerCase, wrapUndefined, log)  // output: <javascript>undefined</javascript>
// WHY?!
// In pipe, the output of the current function, is the input passed to the next function
// can't passed `wrapUndefined("div")` because each argument of `pipe` needs to be a function
